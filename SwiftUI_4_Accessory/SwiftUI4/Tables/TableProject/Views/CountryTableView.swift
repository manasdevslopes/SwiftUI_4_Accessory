...
struct CountryTableView: View {
  @State private var sampleCities = City.sample.sorted(using: KeyPathComparator(\.name)) // array
  @State private var sortOrder = [KeyPathComparator(\City.name)] // sort order
  @State private var selection: City.ID? // Selction
